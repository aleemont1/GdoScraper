...
class ConadOfferParser:
    ...
    def __init__(self) -> None:
        ...
        # Compiled split price pattern: captures euros and cents separated by text/symbols (e.g. 19 € C U O R E ,90)
    ...
    def de_space_uppercase(self, text: str) -> str:
        ...
        for w in words:
            ...
            if last_clean.isupper() and w_clean.isupper() and last_clean not in NO_MERGE and w_clean not in NO_MERGE and (len(last_clean) <= 2 or len(w_clean) <= 2):
